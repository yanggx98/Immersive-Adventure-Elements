...
public class GemSlotItems {
    ...
    public static void onInitialize(){
        ...
        HEALTH_UPTAKE_GEM_LEVEL_1 = register("health_uptake_gem_level_1", new GemItem(GemEffectEntries.GEM_EFFECT_ENTRY_CRITICAL_DAMAGE_LEVEL_1));
        HEALTH_UPTAKE_GEM_LEVEL_2 = register("health_uptake_gem_level_2", new GemItem(GemEffectEntries.GEM_EFFECT_ENTRY_CRITICAL_DAMAGE_LEVEL_2));
        HEALTH_UPTAKE_GEM_LEVEL_3 = register("health_uptake_gem_level_3", new GemItem(GemEffectEntries.GEM_EFFECT_ENTRY_CRITICAL_DAMAGE_LEVEL_3));

        EXTRA_DAMAGE_GEM_LEVEL_1 = register("extra_damage_gem_level_1", new GemItem(GemEffectEntries.GEM_EFFECT_ENTRY_CRITICAL_DAMAGE_LEVEL_1));
        EXTRA_DAMAGE_GEM_LEVEL_2 = register("extra_damage_gem_level_2", new GemItem(GemEffectEntries.GEM_EFFECT_ENTRY_CRITICAL_DAMAGE_LEVEL_2));
        EXTRA_DAMAGE_GEM_LEVEL_3 = register("extra_damage_gem_level_3", new GemItem(GemEffectEntries.GEM_EFFECT_ENTRY_CRITICAL_DAMAGE_LEVEL_3));
    }
